...
第一，如果你说英语，下载 clean(English).py；
如果你说中文，下载 clean(Chinese).py。
把它们放在根目录。
...
运行 pkg install python

第四，连接存储权限：
运行 termux-setup-storage
然后输入"y"
